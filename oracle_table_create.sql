...
ALTER TABLE ADDHAR_DTLS DROP CONSTRAINT ADDHAR_DTLS_PK;
...
UPDATE ADDHAR_DTLS SET AGE = 33 WHERE FIRST_NAME ='AMIT';
COMMIT;

ALTER TABLE ADDHAR_DTLS ADD CONSTRAINT ADDHAR_DTLS_PK PRIMARY KEY (AGE);
...
ALTER TABLE ADDHAR_DTLS DROP CONSTRAINT ADDHAR_DTLS_PK;
ALTER TABLE ADDHAR_DTLS ADD CONSTRAINT ADDHAR_DTLS_PK PRIMARY KEY (ADDHAR_NUMBER,AGE);



CREATE TABLE PATIENT_DTLS(PATIENT_ID NUMBER(10), PATIENT_NAME VARCHAR2(100), PATIENT_AGE NUMBER(3), TSH_LEVEL NUMBER(5,2), LAST_MODIFIED_DT TIMESTAMP);

ALTER TABLE PATIENT_DTLS ADD CONSTRAINT PATIENT_DTLS_PK PRIMARY KEY(PATIENT_ID);

INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (100,'ASOK',32,3.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (101,'AMAL',32,4.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (102,'SHAM',32,2.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (103,'JOJO',32,6.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (104,'KUSHAL',32,2.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (105,'SUBIR',32,1.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (106,'SUMIT',32,0.4,SYSDATE);
COMMIT;

INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (107,'ALOK',30,7.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (108,'KAMAL',29,2.4,SYSDATE);
COMMIT;


UPDATE PATIENT_DTLS SET TSH_LEVEL = 11.0,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 102;
UPDATE PATIENT_DTLS SET TSH_LEVEL = 8.9,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 106;
COMMIT;

INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (109,'KAUSHIK',35,6.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (110,'HASAN',28,7.4,SYSDATE);
COMMIT;

UPDATE PATIENT_DTLS SET TSH_LEVEL = 1.0,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 109;
UPDATE PATIENT_DTLS SET TSH_LEVEL = 2.9,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 102;
COMMIT;

INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (111,'ARGHYA',35,0.4,SYSDATE);
INSERT INTO PATIENT_DTLS(PATIENT_ID,PATIENT_NAME,PATIENT_AGE,TSH_LEVEL,LAST_MODIFIED_DT) VALUES (112,'TANMAY',28,2.4,SYSDATE);
COMMIT;


UPDATE PATIENT_DTLS SET TSH_LEVEL = 5.0,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 111;
UPDATE PATIENT_DTLS SET TSH_LEVEL = 9.9,LAST_MODIFIED_DT = SYSDATE WHERE PATIENT_ID = 112;
COMMIT;
